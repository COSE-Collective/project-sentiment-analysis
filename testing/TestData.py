...
def data_preprocessing(data):
    ...
    data["Sentiment"] = np.array(list(map(lambda y: 2 if y == 4
    else (1 if y == 2 else 0), data["Sentiment"])))
    step += 1
...
if __name__ == '__main__':
    ...
    test_data2 = pd.read_csv('twitter_test3.csv', encoding='latin1', header=None)
    ...
    test_data.to_csv('test3.csv', encoding='utf-8', index=False)
